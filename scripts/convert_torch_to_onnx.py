...
model_paths = OrderedDict(
    [
        (
            "j",
            "/home/laptq/ACLNet/runs/ACLNet/fs26/v219--satudora_veo3_awlrecord--split-14-class--nodistinct--2s-15frames--v2/model_0/best_harmonic_mean_recall_epoch_3.pth",
        ),
        # (
        #     "b",
        ...
        (
            "jm",
            "/home/laptq/ACLNet/runs/ACLNet/fs26/v221--satudora_veo3_awlrecord--split-14-class--nodistinct--2s-15frames--v2--jm/model_0/best_harmonic_mean_recall_epoch_4.pth",
        ),
        # (
        #     "bm",
...
pathf_output = "/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert-torch-to-onnx/fs26/ACLNet/{}.onnx".format(
    "--".join(
        [
