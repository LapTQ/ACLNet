graph = "coco_headless"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ACLNet/fs26/v222--satudora_veo3_awlrecord--split-14-class--nodistinct--2s-15frames--v2--bm"
...
train_pipeline = [
    ...
    dict(type="GenSkeFeat", dataset="coco_headless", feats=['bm']),
